        ...
        <div id="bd">
            <div id="header" class="yui-g">
                <a href="<?php echo Link::Build(''); ?>">
                    <img src="<?php echo Link::Build('images/images/tshirtshop.png'); ?>" alt="tshirtshop logo" />
                </a>
            </div>
            <div id="contents" class="yui-g">
                ...
                <p>
                    ...
                    if you're looking for T-shirts,or <a href="<?php echo ADMIN_ERROR_MAIL; ?>">email us</a>
