...
class Catalog
{
    ...
    {
        // Build the SQL query
        $sql = 'CALL catalog_add_attribute(:attribute_name)'; // Build the parameters array
    ...
    {
        // Build the SQL query
        $sql = 'CALL catalog_delete_attribute_value(:attribute_value_id)'; // Build the parameters array
...
:source_category_id, :target_category_id)';
    ...
    public static function AssignAttributeValueToProduct(
        $productId,
        $attributeValueId
    )
    {
...
:product_id, :attribute_value_id)';
    ...
    public static function RemoveProductAttributeValue(
        $productId,
        $attributeValueId
    )
    {
