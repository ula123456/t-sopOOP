...
<form method="post" action="{$obj->mLinkToCreditCardDetails}">
    ...
    <table class="customer-table">
        <tr>
            <td>Card Holder:</td>
            <td>
                <input type="text" name="cardHolder" size="32" value="{$obj->mPlainCreditCard.card_holder}" />
        ...
        <tr>
            ...
            <td>
                <input type="text" name="cardNumber" size="32" value="{$obj->mPlainCreditCard.card_number}" />
        ...
        <tr>
            ...
            <td>
                <input type="text" name="expDate" size="32" value="{$obj->mPlainCreditCard.expiry_date}" />
        ...
        <tr>
            ...
            <td>
                <input type="text" name="issueDate" size="32" value="{$obj->mPlainCreditCard.issue_date}" />
            </td>
        </tr>
        <tr>
            <td>Issue Number (if applicable):</td>
            <td>
                <input type="text" name="issueNumber" size="32" value="{$obj->mPlainCreditCard.issue_number}" />
            </td>
        </tr>
        <tr>
            <td>Card Type:</td>
