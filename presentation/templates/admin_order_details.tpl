...
<form method="get" action="{$obj->mLinkToAdmin}">
    ...
    <table class="borderless-table">
        ...
        <tr>
            ...
            <td>
                {$obj->mOrderInfo.created_on}
            </td>
        </tr>
        <tr>
            <td class="bold-text">Date Shipped: </td>
            <td>
                {$obj->mOrderInfo.shipped_on}
            </td>
        </tr>
        <tr>
...
selected=$obj->mOrderInfo.status}
        ...
        <tr>
            ...
            <td>
                <input name="authCode" type="text" size="50" value="{$obj->mOrderInfo.auth_code}"
        ...
        <tr>
            ...
            <td>
                <input name="reference" type="text" size="50" value="{$obj->mOrderInfo.reference}"
                    {if ! $obj->mEditEnabled} disabled="disabled" {/if} />
            <td>
        </tr>
        <tr>
            ...
            <td>
                <input name="comments" type="text" size="50" value="{$obj->mOrderInfo.comments}"
                    {if ! $obj->mEditEnabled} disabled="disabled" {/if} />
            <td>
        </tr>
        <tr>
    ...
    <p>
        <input type="submit" name="submitEdit" value="Edit" {if $obj->mEditEnabled} disabled="disabled" {/if} />
        <input type="submit" name="submitUpdate" value="Update" {if ! $obj->mEditEnabled} disabled="disabled" {/if} />
        <input type="submit" name="submitCancel" value="Cancel" {if ! $obj->mEditEnabled} disabled="disabled" {/if} />
    ...
    <table class="tss-table">
        ...
        {section name=i loop=$obj->mOrderDetails}<tr>
