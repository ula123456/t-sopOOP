...
<form enctype="multipart/form-data" method="post" action="{$obj->mLinkToProductDetailsAdmin}">
        ...
        <tbody>
            <tr>
                ...
                <td valign="top">
                    ...
                    <p>
                        {html_options name="ProductDisplay" options=$obj->mProductDisplayOptions
    ...
    {if $obj->mProduct.image}
        <p>
            <img src="images/product_images/{$obj->mProduct.image}" border="0" alt="{$obj->mProduct.name} image" />
        </p>
    {/if}
    <p>
    ...
    {if $obj->mProduct.image_2}
        <p>
            <img src="images/product_images/{$obj->mProduct.image_2}" border="0" alt="{$obj->mProduct.name} image 2" />
        </p>
    {/if}
    <p>
    ...
    {if $obj->mProduct.thumbnail}
        <p>
            <img src="images/product_images/{$obj->mProduct.thumbnail}" border="0" alt="{$obj->mProduct.name} thumbnail" />
        </p>
    {/if}
</form>