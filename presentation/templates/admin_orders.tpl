...
<form method="get" action="{$obj->mLinkToAdmin}">
    ...
    <p>
        ...
        <input name="recordCount" type="number" value="{$obj->mRecordCount}" />
    ...
    <p>
        ...
        <select name="customer_id">
            {section name=i loop=$obj->mCustomers}
                <option value="{$obj->mCustomers[i].customer_id}" {if $obj->mCustomers[i].customer_id == $obj->mCustomerId}
    ...
    <p>
        ...
        <input name="startDate" type="datetime-local" value="{$obj->mStartDate}" />
        <font class="bold-text">and</font>
        <input name="endDate" type="datetime-local" value="{$obj->mEndDate}" />
